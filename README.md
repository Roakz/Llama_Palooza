...
**2. Application features**<br>
  ...
  **2.5** Error Handling<br><br>

**3. User Guide**<br>
  **3.1** User instructions<br>
  **3.2** Game rules<br><br>

**4. Flow chart diagram**<br><br>

**5. App implementation**<br><br>
...
**The second class** is the Sloth Boss class. Upon initialization the sloth class will randomly generate its attributes for each attribute area I.E Health, Attack & Hp. This will ensure fair and interesting game play.<br />
